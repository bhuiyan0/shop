...
const parents = [
  ...
  {
    slug: "frozen-bakery",
    nameEn: "Frozen & Bakery",
    nameBn: "ফ্রোজেন ও বেকারি",
    keyword: "bakery",
    lock: 93,
  },
  {
...
const products: SeedProduct[] = [
  // --- Rice & Grains ---
  {
    ...
    nameBn: "মিনিকেট চাল",
    descriptionEn:
      "Premium fine-grain miniket rice, cleaned and ready to cook.",
    descriptionBn:
      "প্রিমিয়াম সরু দানার মিনিকেট চাল, পরিষ্কার ও রান্নার জন্য প্রস্তুত।",
    comparePriceTk: 410,
  ...
  {
    slug: "najirshail-rice",
    nameEn: "Najirshail Rice",
  ...
  },
  {
    ...
    nameBn: "আটা",
    descriptionEn:
      "Stone-ground whole wheat flour for soft rutis and parathas.",
  ...
  {
    slug: "black-tea",
    nameEn: "Premium Black Tea",
    nameBn: "প্রিমিয়াম কালো চা",
  ...
  {
    slug: "powder-milk",
    nameEn: "Full Cream Milk Powder",
    nameBn: "ফুল ক্রিম গুঁড়া দুধ",
  ...
  {
    slug: "toilet-tissue",
    nameEn: "Toilet Tissue (4 rolls)",
    nameBn: "টয়লেট টিস্যু (৪ রোল)",
  ...
  // --- Breakfast & Cereal ---
  {
    ...
    categorySlug: "breakfast-cereal",
    keyword: "cornflakes,cereal",
    lock: 261,
    variants: [
      {
        sku: "BRK-CRN-500",
  ...
  // --- Noodles & Pasta ---
  {
    ...
    nameBn: "ইনস্ট্যান্ট নুডলস (৮ প্যাক)",
  ...
  {
    slug: "baby-food-cereal",
    nameEn: "Baby Food Cereal",
    nameBn: "বেবি ফুড সিরিয়াল",
  ...
  },
  {
    ...
    nameBn: "অ্যান্টি-ড্যান্ড্রাফ শ্যাম্পু",
...
async function main() {
  ...
  console.log(
    `  ✓ ${parents.length} parent + ${categories.length} sub categories`,
  );
